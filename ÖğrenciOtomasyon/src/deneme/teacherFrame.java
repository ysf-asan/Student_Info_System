...
public class teacherFrame extends JFrame {
	...
	public teacherFrame() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Nesneye Y\u00F6enlik Programlama", "Veri Yap\u0131lar\u0131", "Devreler ve Sistemler", "Differential Equations", "Lojik Devre Tasar\u0131m\u0131", "Olas\u0131l\u0131k Teorisi ve \u0130statistik"}));
		...
		btnAddStudent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Student student = new Student(name,id,grade,course,gender);
