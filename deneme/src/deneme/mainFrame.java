	...
	public mainFrame() {
		...
		btnNewButton_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String userType = (String) JOptionPane.showInputDialog(null,"Hangi şifreyi değiştirmek istiyorsunuz? (Öğrenci-Öğretmen)", "Şifre seçimi", JOptionPane.QUESTION_MESSAGE,null,options,options[0]);
				if(userType != null){
