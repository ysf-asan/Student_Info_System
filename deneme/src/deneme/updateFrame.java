...
public class updateFrame extends JFrame implements updateFunc{
	 ...
	 * Create the frame.
	 */
	public updateFrame(final Student student, teacherFrame teacherFrame) {
		setTitle("Güncelleme Ekranı");
		setIconImage(Toolkit.getDefaultToolkit().getImage(updateFrame.class.getResource("/deneme/resource/iu_small_sizee.png")));
