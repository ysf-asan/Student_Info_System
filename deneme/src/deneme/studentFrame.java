...
public class studentFrame extends JFrame implements studentFunc{
	...
	public studentFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(studentFrame.class.getResource("/deneme/resource/iu_small_sizee.png")));
		...
		JLabel lblEnterYourStudents = new JLabel("Enter your ID");
		lblEnterYourStudents.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblEnterYourStudents.setBounds(64, 49, 104, 35);
		...
		btnNewButton_2.setBounds(24, 15, 104, 23);
		...
		textArea.setBounds(10, 229, 484, 166);
